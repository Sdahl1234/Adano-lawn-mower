...
async def async_setup_entry(hass: HomeAssistant, entry, async_add_entities) -> None:
    ...
    async_add_entities(
        [
            AdanoRainSwitch(coordinator, "Rain sensor", "adano_rain_sensor")
    ...
    async_add_entities(
        [
            AdanoMultiZoneSwitch(coordinator, "MultiZone", "adano_multi_zone")
            for coordinator in robot_coordinators(hass, entry)
        ]
    )
    ...
    async_add_entities(
        [
            AdanoMultiZoneAutoSwitch(
                coordinator, "MultiZone auto", "adano_multi_zone_auto"
            )
            for coordinator in robot_coordinators(hass, entry)
        ]
    )
    ...
    async_add_entities(
        [
            AdanoScheduleSwitch(coordinator, "Schedule active", "schedule_active")
            for coordinator in robot_coordinators(hass, entry)
        ]
    )


class AdanoRainSwitch(AdanoEntity, SwitchEntity):
    """LawnMower switches."""
...
class AdanoMultiZoneSwitch(AdanoEntity, SwitchEntity):
    """LawnMower switches."""
...
class AdanoMultiZoneAutoSwitch(AdanoEntity, SwitchEntity):
    """LawnMower switches."""
...
class AdanoScheduleSwitch(AdanoEntity, SwitchEntity):
    """LawnMower switches."""
